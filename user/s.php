...
// Renew the book if s_no is provided
if (isset($_GET['s_no'])) {
    $s_no = $_GET['s_no'];  

    // Prepare SQL query for renewing the book
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <?php
                        ...
                        // Fetch book name from the books table using book_id
                    ...
                    ?>
                    <tr>
                        <td><?php echo $book_name; ?></td> <!-- Book Name -->
                        <td><?php echo $book_author; ?></td>
                        <td><?php echo $issue_date; ?></td>
                        <td><?php echo $renewal_date; ?></td>
                        <td>
                            <?php if ($overdue_days > 0): ?>
                                <strong class="overdue" style="color:red">Overdue by <?php echo $overdue_days; ?> days</strong>
                            <?php else: ?>
                                <a href="?s_no=<?php echo $row['s_no']; ?>" class="renew">Renew</a>
                            <?php endif; ?>
                        </td>
